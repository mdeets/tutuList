...
const pathToIcon = "/theResources/lightMode/50x50/"; // light -> dark or etc to change icons theme
...
const table_completedTasks = "tutu_completedTasks3";
const table_todayTasks = "tutu_todayTasks2";
